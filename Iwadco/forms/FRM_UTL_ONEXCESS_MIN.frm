...
Begin VB.Form frm_utl_onexcess_min 
   ...
   Begin Project1.isButton cmdCancel 
      ...
      _extentx        =   2355
      _extenty        =   741
      icon            =   "FRM_UTL_ONEXCESS_MIN.frx":0000
      style           =   5
      caption         =   "&Cancel"
      iconsize        =   20
      iconalign       =   1
      ...
      tooltiptype     =   0
      ttforecolor     =   0
      font            =   "FRM_UTL_ONEXCESS_MIN.frx":1709C
   End
   Begin Project1.isButton cmdedit 
      ...
      _extentx        =   2355
      _extenty        =   741
      icon            =   "FRM_UTL_ONEXCESS_MIN.frx":170C4
      style           =   5
      caption         =   "&Edit"
      iconsize        =   20
      iconalign       =   1
      ...
      tooltiptype     =   0
      ttforecolor     =   0
      font            =   "FRM_UTL_ONEXCESS_MIN.frx":2C238
   End
End
...
lstview.lstDatabase sql, LST_ONEXCSS_MIN_RATE
End Sub
